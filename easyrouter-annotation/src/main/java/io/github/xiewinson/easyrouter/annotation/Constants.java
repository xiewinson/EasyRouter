...
public class Constants {
    ...
    public static final String TABLE_PACKAGE_NAME = "io.github.xiewinson.easyrouter.core";
    ...
    public static final String LIBRARY_PACKAGE_INNER = "io.github.xiewinson.easyrouter.library.inner";
    public static final String LIBRARY_PACKAGE = "io.github.xiewinson.easyrouter.library";
    public static final String LIBRARY_PACKAGE_REQUEST = "io.github.xiewinson.easyrouter.library.request";
